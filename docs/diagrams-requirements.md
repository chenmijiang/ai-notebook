...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  MVP
        │                   │                      │                    │
    ⚫ 填写项目名称       ⚫ 输入任务标题         ⚫ 看板视图          ⚫ 站内消息
        和描述           ⚫ 设置截止日期         ⚫ 任务列表          ⚫ @提及成员
    ⚫ 添加团队成员       ⚫ 分配给成员           ⚫ 基础筛选
                        ⚫ 标记完成状态
        │                   │                      │                    │
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  V1.1
        │                   │                      │                    │
    ⚪ 使用项目模板       ⚪ 添加任务描述          ⚪ 甘特图视图         ⚪ 邮件通知
    ⚪ 设置权限角色       ⚪ 添加评论             ⚪ 燃尽图             ⚪ 日历集成
                        ⚪ 上传附件             ⚪ 工时统计            ⚪ 移动端推送
                        ⚪ 设置子任务
        │                   │                      │                    │
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  V1.2
        │                   │                      │                    │
    ⚪ 自定义字段         ⚪ 任务依赖关系         ⚪ 自定义报表         ⚪ 集成Slack
    ⚪ 项目模板库         ⚪ 重复任务设置         ⚪ 数据看板           ⚪ 视频会议
    ⚪ 工作流自定义       ⚪ 批量操作             ⚪ AI 洞察           ⚪ 钉钉/企微集成
```
...
| 迭代 | 活动     | 用户故事                                                                   |
| ---- | -------- | -------------------------------------------------------------------------- |
| MVP  | 创建项目 | 作为**团队Leader**，我想要**填写项目名称和描述**，以便**快速创建新项目**   |
| MVP  | 管理任务 | 作为**项目成员**，我想要**创建任务并分配给同事**，以便**明确工作职责**     |
| MVP  | 跟踪进度 | 作为**项目经理**，我想要**在看板上查看所有任务**，以便**了解项目整体状态** |
| V1.1 | 管理任务 | 作为**开发人员**，我想要**为任务添加评论和附件**，以便**与团队沟通细节**   |
| V1.1 | 跟踪进度 | 作为**项目经理**，我想要**查看燃尽图**，以便**评估迭代进度和风险**         |
| V1.2 | 管理任务 | 作为**项目经理**，我想要**设置任务依赖关系**，以便**合理安排工作顺序**     |
